...
import { deleteAction, getAction,downFile,getFileAccessHttpUrl,YesOrNoAction } from '@/api/manageTeamAllList'
import Vue from 'vue'
...
export const JeecgListMixin = {
  ...
  methods:{
    ...
    getQueryParams() {
      ...
      // }
      // console.log(this.$store.getters.userInfo,'params111')
      // console.log(this.$store.getters.userInfo.roleName,'params222')
