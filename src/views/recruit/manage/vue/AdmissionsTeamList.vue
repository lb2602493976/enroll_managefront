        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item>
                <a-popconfirm title='删除会将团队下成员一起删除，确定是否删除?' @confirm="() => handleDelete(record.id)">
                  <a>删除</a>
                </a-popconfirm>
              </a-menu-item>
            </a-menu>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/manage/admissionsTeam/list",
          delete: "/manage/admissionsTeam/delete",
          deleteBatch: "/manage/admissionsTeam/deleteBatch",
          exportXlsUrl: "/manage/admissionsTeam/exportXls",
          importExcelUrl: "manage/admissionsTeam/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'int',value:'headId',text:'团队负责人',dictCode:''})
        fieldList.push({type:'string',value:'territory',text:'负责区域',dictCode:''})
