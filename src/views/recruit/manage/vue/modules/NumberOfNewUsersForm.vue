        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="学校地址" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="schoolAddress">
              <a-input v-model="model.schoolAddress" placeholder="请输入学校地址"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="学校网址" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="schoolWebsite">
              <a-input v-model="model.schoolWebsite" placeholder="请输入学校网址"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="招生办电话" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="admissionsTel">
              <a-input v-model="model.admissionsTel" placeholder="请输入招生办电话"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
