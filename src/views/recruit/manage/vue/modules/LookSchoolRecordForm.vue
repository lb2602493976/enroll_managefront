    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="看校时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="time">
              <j-date placeholder="请选择看校时间" v-model="model.time"  style="width: 100%" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/manage/lookSchoolRecord/add",
          edit: "/manage/lookSchoolRecord/edit",
          queryById: "/manage/lookSchoolRecord/queryById"
        }
      }
    },
    computed: {
