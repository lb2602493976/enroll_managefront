    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="key" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="secretkey">
              <a-input v-model="model.secretkey" placeholder="请输入key"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/manage/appKey/add",
          edit: "/manage/appKey/edit",
          queryById: "/manage/appKey/queryById"
        }
      }
    },
    computed: {
