<template>
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled" v-if="!showCol">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
            ...
            <a-form-model-item label="图标" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="moduleIcon">
               <a-upload
                ...
                >
                  ...
                  <img style="width: 128px;height: 128px;" v-if="model.moduleIcon" :src="model.moduleIcon" alt="avatar" />
                  <div v-else>
          ...
          <a-col :span="24" v-if="showCol">
            <a-form-model-item label="模块内容" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="cmContent">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/manage/recruitModule/add",
          edit: "/manage/recruitModule/edit",
          queryById: "/manage/recruitModule/queryById"
        },
        showCol:true,
      }
    },
    ...
    methods: {
      handleChange(info) {
        ...
        if (info.file.status === 'done') {
          ...
          this.model.moduleIcon=info.file.response.url
        }
      },
      // 限制图片大小
      beforeUpload(file) {
