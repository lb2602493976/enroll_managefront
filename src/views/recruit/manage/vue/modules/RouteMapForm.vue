    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="乘车方式" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="driveWay">
              <a-input v-model="model.driveWay" placeholder="请输入乘车方式"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/manage/routeMap/add",
          edit: "/manage/routeMap/edit",
          queryById: "/manage/routeMap/queryById"
        }
      }
    },
    computed: {
