        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="租户" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="tenantId">
              <j-dict-select-tag type="list" v-model="model.tenantId" dictCode="sys_tenant,name,id" placeholder="请选择租户" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/manage/cesTeacher/add",
          edit: "/manage/cesTeacher/edit",
          queryById: "/manage/cesTeacher/queryById"
        }
      }
    },
    computed: {
