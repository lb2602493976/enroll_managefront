  ...
  <a-row :gutter="10">
        ...
        <div style="margin-top: 15px">
          ...
          >
            <span slot="action" slot-scope="text, record">
              ...
              <span v-if="!(record.roleCode == 'plat_admin')">
    ...
    <a-col :md="rightColMd" :sm="24" v-if="this.rightcolval == 1">
      <a-card :bordered="false">
        ...
        <select-user-modal-tenant ref="selectUserModalTenant" @selectFinished="selectOK"></select-user-modal-tenant>
      </a-card>
    </a-col>
  </a-row>
</template>
...
import SelectUserModalTenant from './modules/SelectUserModalTenant'
  ...
  methods: {
    ...
    handleAddUserRole() {
      if (this.currentRoleId == '') {
        ...
        this.$refs.selectUserModalTenant.visible = true
      }
    },
    handleOpen(record) {
      this.rightcolval = 1
