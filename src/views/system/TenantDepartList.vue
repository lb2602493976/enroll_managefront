    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          <a-button @click="handleAdd(1)" type="primary" v-if="addShow">添加部门</a-button>
    ...
    <a-col :md="12" :sm="24">
      <a-tabs defaultActiveKey="1">
        ...
        <a-tab-pane tab="用户信息" key="2" forceRender>
          ...
          <dept-user-info-tenant ref="DeptUserInfoTenant" @clearSelectedDepartKeys="clearSelectedDepartKeys"></dept-user-info-tenant>
        </a-tab-pane>
      </a-tabs>
...
<script>
  ...
  import DepartUserList from './DepartUserList'
  import { axios } from '@/utils/request'
  import DeptUserInfoTenant from './modules/DeptUserInfoTenant'
  // 表头
  const columns = [
    {
      title: '机构名称',
  ...
  export default {
    ...
    methods: {
      show(departId){
        ...
        this.$refs.DeptUserInfoTenant.currentDeptId = departId
      },
      clearSelectedDepartKeys() {
        this.checkedKeys = []
        this.selectedKeys = []
        this.currentDeptId = ''
        this.$refs.DeptUserInfoTenant.currentDeptId = ''
      },
      loadData() {
        this.refresh()
      },
      ...
      onSelect(selectedKeys, e) {
        ...
        this.$refs.DeptUserInfoTenant.onClearSelected()
        this.$refs.DeptUserInfoTenant.open(data)
      },
